...
$_lang['setting_modopenid.page_password'] = 'Forgot Password Page';
$_lang['setting_modopenid.page_password_desc'] = 'Resource ID for forgot password page (0: disable forgot password)';
$_lang['setting_modopenid.page_sso'] = 'SSO Session/Folder';
