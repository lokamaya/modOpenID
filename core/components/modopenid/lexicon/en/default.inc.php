...
$_lang['setting_modopenid.http_proxy'] = 'HTTP Proxy';
$_lang['setting_modopenid.http_proxy_desc'] = 'Scopes used to get detail of current user (see: https://auth0.com/docs/get-started/apis/scopes/openid-connect-scopes)';
...
$_lang['setting_modopenid.certpath_desc'] = 'Enable/disable debuging (default:false)';
$_lang['setting_modopenid.login_redirect'] = 'Login Redirect';
$_lang['setting_modopenid.login_redirect_desc'] = 'URL after login via Identity Provider';
$_lang['setting_modopenid.logout_redirect'] = 'Logout Redirect';
$_lang['setting_modopenid.logout_redirect_desc'] = 'URL after logout via Identity Provider';
